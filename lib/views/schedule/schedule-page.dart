          ...
          Column(
            children: <Widget>[
              ...
              Column(children: <Widget>[
                // a dot
                Container(height: 20, width: 20, decoration: BoxDecoration(color: Constants.GREEN, borderRadius: new BorderRadius.all(const Radius.circular(10)), ),),
                // a vertical line
                Container(height: 80, width: 1, color: Constants.GREEN,)
              ],),
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("15 Dec 2021", style: TextStyle(color: Constants.GRAY),),
                    Text("7:00 - 8:00", style: TextStyle(color: Constants.GRAY),),
                  ],
                ),
                SizedBox(height: 20,),
                // dentist title
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Text("Dentist", style: TextStyle(color: Constants.GRAY),),
                    Text("Nurse", style: TextStyle(color: Constants.GRAY),)
                  ],
                ),
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text("Appointments", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Constants.BLACK),),
